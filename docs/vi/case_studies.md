...
```mermaid
graph LR
    subgraph "🛡️ Hệ sinh thái An ninh mạng Việt Nam"
        direction TB
        VNCS["VNCS<br/>Pentest (CREST)"]
        CYSTACK["CyStack<br/>Bug Bounty"]
        CMC["CMC Cyber<br/>MSSP/SOC"]
        BKAV["BKAV<br/>Endpoint/AV"]
        VCS["Viettel VCS<br/>Threat Intel"]
        CYRADAR["Cyradar<br/>AI Threat Detection"]
    end

    GOV_C["🏛️ Cơ quan<br/>nhà nước"] --> VNCS & CMC & BKAV & VCS
    BANK_C["🏦 Ngân hàng"] --> VNCS & CYSTACK & CMC
    ENTERPRISE["🏢 Doanh nghiệp"] --> CMC & BKAV & CYRADAR & VCS

    style VCS fill:#dc2626,color:#fff
    style VNCS fill:#2563eb,color:#fff
    style CYSTACK fill:#7c3aed,color:#fff
    style CMC fill:#059669,color:#fff
    style BKAV fill:#d97706,color:#fff
    style CYRADAR fill:#0891b2,color:#fff
```
